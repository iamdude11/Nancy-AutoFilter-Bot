...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/XeonFlixGroup')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/XeonFlixGroup') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
